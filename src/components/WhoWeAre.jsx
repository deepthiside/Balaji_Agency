...
export default function WhoWeAre() {
  ...
  return (
    <section id="who-we-are" ref={containerRef} className="relative w-full py-20 px-6 md:px-16 lg:px-20 bg-black overflow-hidden border-t border-white/10">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12 items-center">
        ...
        >
          <div className="liquid-glass rounded-[2rem] p-2 aspect-[4/3] w-full">
            <div className="w-full h-full rounded-[1.8rem] bg-zinc-900 overflow-hidden relative">
              <TiltedCard
                ...
                overlayContent={
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent w-full h-full rounded-[15px]"></div>
                }
              />
            </div>
          </div>
