    ...
    <section className="py-24 relative overflow-hidden bg-[#E3DAC9] border-t border-[#1C1917]/10">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="relative aspect-[16/10] md:aspect-[16/8] overflow-hidden rounded-3xl border border-stone-200 bg-white shadow-2xl shadow-black/25 group">
            ...
            <div className="absolute inset-y-0 left-0 flex items-center px-4 md:px-8">
              <button
                onClick={prevReview}
                className="w-12 h-12 rounded-full bg-white/90 border border-stone-200 shadow-md text-stone-700 hover:bg-[#59425A] hover:text-white hover:border-[#59425A] transition-all active:scale-95 group/btn flex items-center justify-center"
              >
          ...
          <div className="flex justify-center gap-3 mt-12">
            {reviewImages.map((_, i) => (
              <button
                ...
                className={`h-1.5 rounded-full transition-all duration-300 ${currentIndex === i ? 'w-8 bg-[#59425A]' : 'w-2 bg-stone-300 hover:bg-stone-400'
                  }`}
              />
            ))}
          </div>
