...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.setScale();
    this.padding = this.plane.scale.y * 0.3; // Use relative padding to prevent spreading too far
...
export default function FlyingPosters({
  ...
  useEffect(() => {
    ...
    instanceRef.current = new Canvas({
      container: containerRef.current, canvas: canvasRef.current, items, planeWidth, planeHeight,
