...
// Custom high-fidelity SplitText shim to replace the paid Club GSAP dependency
class GSAPSplitText {
  constructor(element, options) {
    ...
    element.innerHTML = ''; // clear parent

    words.forEach((word, wordIndex) => {
      const wordSpan = document.createElement('span');
      wordSpan.className = options.wordsClass || 'shuffle-word';
      ...
      letters.forEach(char => {
        ...
        charSpan.className = options.charsClass || 'shuffle-char';
